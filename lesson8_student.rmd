...
# 'I() stands for 'as-is'.  will transform before using in regression
m1 <- lm(I(log(price)) ~ I(carat^(1/3)), data = diamonds)
m2 <- update(m1, ~ . + carat)
m3 <- update(m2, ~ . + cut)
m4 <- update(m3, ~ . + color)
m5 <- update(m4, ~ . + clarity)
# produce a table of estimates for several models
...
library("bitops", lib.loc="~/Anaconda3/envs/py37pipped/Lib/R/library")
library("RCurl", lib.loc="~/Anaconda3/envs/py37pipped/Lib/R/library")
# Rcurl needs libcurl, not available on windows(easily)

...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# Scatterplot - volatile acidity by quality
...
Below we'll use gg pairs to generate a grid of pairwise plots.
...
### Plot One
```{r echo=FALSE, message=FALSE, warning=FALSE}
# Boxplot - quality by volatile acidity
ggplot(wine, aes(factor(quality), volatile.acidity, color = factor(quality))) +
  geom_boxplot(outlier.colour = "red") +
  stat_summary(fun.y = mean,
  geom = 'point',
...
### Plot Two
```{r echo=FALSE, message=FALSE, warning=FALSE}
# Boxplot - quality by citric acid
ggplot(wine, aes(factor(quality), citric.acid, color = factor(quality))) +
  geom_boxplot(outlier.colour = "red") +
  stat_summary(fun.y = mean,
  geom = 'point',
